...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://vf2ho0nam3.execute-api.eu-west-1.amazonaws.com/prod';
    ...
    apigClient.filenameGet = function (params, body, additionalParams) {
        ...
        return apiGatewayClient.makeRequest(filenameGetRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.filenamePost = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var filenamePostRequest = {
        ...
        return apiGatewayClient.makeRequest(filenamePostRequest, authType, additionalParams, config.apiKey);
    };
    ...
    apigClient.wsPartnerDownloadPocCopyPost = function (params, body, additionalParams) {
        ...
        var wsPartnerDownloadPocCopyPostRequest = {
            verb: 'post'.toUpperCase(),
    ...
    apigClient.wsPartnerDownloadPocSigcredGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var wsPartnerDownloadPocSigcredGetRequest = {
            verb: 'get'.toUpperCase(),
        ...
        return apiGatewayClient.makeRequest(wsPartnerDownloadPocSigcredGetRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.wsPartnerDownloadPocSigcredPost = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var wsPartnerDownloadPocSigcredPostRequest = {
            verb: 'post'.toUpperCase(),
            path: pathComponent + uritemplate('/ws-partner-download-poc-sigcred').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
